...
namespace utils
{
    ...
    public:
        ...
        virtual void addRun(long interval, const std::string& oscillation);
        virtual void addBaseline(const std::string& currencyPair, const std::string& bid, const std::string& ask);
        virtual void addOscillation(const std::string& currencyPair, const std::string& rate, char side);
